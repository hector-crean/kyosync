...
//!   (Add/Remove) flow through `CrdtSyncPlugin`. Field sync is opt-in
...
use kyoso_sync::{CrdtSyncPlugin, SchemaSyncedNodeComponentPlugin, SyncStatus};
...
fn main() {
    ...
    app.add_plugins((
        ...
        CrdtSyncPlugin::<GraphNode, GraphEdge>::new(url, room),
