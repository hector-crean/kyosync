...
use kyoso_sync::{
    CrdtSyncPlugin, SchemaSync, SchemaSyncedNodeComponentPlugin, SyncStatus,
};
...
fn build_app(server: SocketAddr, room: &str) -> App {
    ...
    app.add_plugins((
        ...
        CrdtSyncPlugin::<Derived, DerivedEdge>::new(format!("ws://{server}/ws"), room),
...
fn build_tagged_app(server: SocketAddr, room: &str) -> App {
    ...
    app.add_plugins((
        ...
        CrdtSyncPlugin::<Tagged, DerivedEdge>::new(format!("ws://{server}/ws"), room),
...
fn build_counted_app(server: SocketAddr, room: &str) -> App {
    ...
    app.add_plugins((
        ...
        CrdtSyncPlugin::<Counted, DerivedEdge>::new(format!("ws://{server}/ws"), room),
...
fn build_mapped_app(server: SocketAddr, room: &str) -> App {
    ...
    app.add_plugins((
        ...
        CrdtSyncPlugin::<Mapped, DerivedEdge>::new(format!("ws://{server}/ws"), room),
...
fn build_outer_app(server: SocketAddr, room: &str) -> App {
    ...
    app.add_plugins((
        ...
        CrdtSyncPlugin::<Outer, DerivedEdge>::new(format!("ws://{server}/ws"), room),
...
fn build_text_app(server: SocketAddr, room: &str) -> App {
    ...
    app.add_plugins((
        ...
        CrdtSyncPlugin::<TextDoc, DerivedEdge>::new(format!("ws://{server}/ws"), room),
...
fn build_ordered_list_app(server: SocketAddr, room: &str) -> App {
    ...
    app.add_plugins((
        ...
        CrdtSyncPlugin::<OrderedList, DerivedEdge>::new(format!("ws://{server}/ws"), room),
...
fn build_with_builtin_app(server: SocketAddr, room: &str) -> App {
    ...
    app.add_plugins((
        ...
        CrdtSyncPlugin::<WithBuiltin, DerivedEdge>::new(format!("ws://{server}/ws"), room),
...
mod custom_with {
    ...
    impl kyoso_sync::SchemaField for HalvedSchema {
    ...
    fn build_container_app(server: SocketAddr, room: &str) -> App {
        ...
        app.add_plugins((
            ...
            CrdtSyncPlugin::<Container, DerivedEdge>::new(format!("ws://{server}/ws"), room),
